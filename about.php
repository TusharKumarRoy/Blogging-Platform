...
<main class="container about-page" id="main-content" role="main">
  ...
  <section class="team" aria-labelledby="team-heading">
    ...
    <div class="team-grid">
      <article class="team-card" aria-labelledby="tushar-name">
        <img src="assets/team/tushar.jpg" alt="Tushar Kumar Roy" onerror="this.style.display='none'">
        <h4 id="tushar-name">Tushar Kumar Roy</h4>
        <p class="role">Roll: 2107037 — CSE, KUET</p>
        <p class="bio">Team lead; focused on backend logic, data handling, and ensuring the platform is robust and secure.</p>
      </article>

      <article class="team-card" aria-labelledby="armaan-name">
        <img src="assets/team/armaan.jpg" alt="Armaan Rahman Rafi" onerror="this.style.display='none'">
        <h4 id="armaan-name">Armaan Rahman Rafi</h4>
        <p class="role">Roll: 2107046 — CSE, KUET</p>
        <p class="bio">Integration and testing lead; focuses on functionality, QA, and ensuring the project meets requirements.</p>
      </article>

      <article class="team-card" aria-labelledby="shahriar-name">
        <img src="assets/team/shahriar.jpg" alt="Shahriar Aziz Khan" onerror="this.style.display='none'">
        <h4 id="shahriar-name">Shahriar Aziz Khan</h4>
        <p class="role">Roll: 2107034 — CSE, KUET</p>
        <p class="bio">Frontend and UI contributor; works on design, responsive layouts, and improving user experience.</p>
      </article>
    </div>
...
/* Card layout: equal-height columns, vertical stacking inside card */
...
/* Content area grows so bios push footer down uniformly */
...
/* Small screens: tighten spacing and ensure single column where needed */
...
/* Project vision spacing */
.project-vision { margin-top: 1rem; }
</style>
